...
const About = () => {
    return (
        ...
        <section className="about">
            ...
            <h2>Why Choose Us?</h2>
            <ul>
                <li>Fresh and organic vegetables sourced directly from local farmers.</li>
                <li>Easy online ordering with quick delivery to your doorstep.</li>
                <li>Commitment to sustainability and eco-friendly practices.</li>
            </ul>

            <h2>Our Values</h2>
            <p>We prioritize quality, transparency, and customer satisfaction. Join us in our mission to create a healthier and greener world, one vegetable at a time!</p>
        </section>
    </main>
        </div>
    )
